export const de = {
	nav: { projects: 'Projekte', about: 'Über mich', reviews: 'Bewertungen', contact: 'Kontakt' },
	hero: {
		label: 'Webentwickler · Berlin · DACH',
		line1: 'Websites,',
	...
	projects: { heading: 'Projekte', sub: 'Ausgewählte Arbeiten — von der Idee zur fertigen Website.', visit: 'Zur Website', wip: 'In Kürze' },
	about: {
		heading: 'Über mich',
	...
	reviews: { heading: 'Bewertungen', sub: 'Was meine Kunden sagen.' },
	contact: {
		heading: 'Kontakt',
		sub: 'Bereit für eine bessere Website? Schreiben Sie mir.',
		name_label: 'Name', name_placeholder: 'Ihr Name',
		email_label: 'E-Mail', email_placeholder: 'ihre@email.de',
		phone_label: 'Telefon',
		location_label: 'Standort',
		message_label: 'Nachricht', message_placeholder: 'Erzählen Sie mir von Ihrem Projekt...',
		send: 'Nachricht senden',
		availability: 'Verfügbar für neue Projekte',
		copied: 'Kopiert!'
	},
	footer: { tagline: 'Websites, die begeistern.', rights: 'Alle Rechte vorbehalten.', imprint: 'Impressum', privacy: 'Datenschutz' }
} as const;
